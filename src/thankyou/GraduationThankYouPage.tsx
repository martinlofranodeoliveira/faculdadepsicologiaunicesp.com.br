...
import { readGraduationThankYouLead, type GraduationThankYouLead } from './graduationThankYouState'
...
export function GraduationThankYouPage() {
  const [lead, setLead] = useState<GraduationThankYouLead | null>(null)

  useEffect(() => {
    setLead(readGraduationThankYouLead())
  }, [])
  ...
  return (
    <main className="post-thankyou">
        ...
        <div className="post-thankyou__header-inner">
          ...
          <div className="post-thankyou__profile" aria-label="Dados do usuário">
            <div className="post-thankyou__profile-text">
              ...
              <span className="post-thankyou__profile-email">
      ...
      <section className="post-thankyou__hero" aria-label="Vestibular finalizado">
